...
alias "ubuntu"="sh $HOME/.xiaomo/source/macos/shell/ubuntu.sh"
alias "ec2"="sh $HOME/.xiaomo/source/macos/shell/ec2.sh"
alias "dev"="sh $HOME/.xiaomo/source/macos/shell/dev.sh"
alias "prod"="sh $HOME/.xiaomo/source/macos/shell/prod.sh"
alias "parallels"="sh $HOME/.xiaomo/source/macos/shell/parallels.sh"
